<x-admin>
  ...
  <a href="/admin/product" class="btn btn-primary mb-3"><i class="fas fa-arrow-left"> Back</i></a>
  <a href="/admin/product/update-form/{{$product->id}}" class="btn btn-success mb-3"><i class="fas fa-edit"> Update</i></a>
